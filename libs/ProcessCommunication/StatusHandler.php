...
class StatusHandler
{
    ...
    public function __construct($crawler_uniqid, $working_directory)
    {
        ...
        $this->crawlerStatus = new Status();
    }

    /**
     * Returns/reads the current crawler-status
     *
     * @return Status The current crawlerstatus as a Status-object
     */
    public function getCrawlerStatus()
    {
        ...
        {
            $this->crawlerStatus = Utils::deserializeFromFile($this->working_directory."crawlerstatus.tmp");
            if ($this->crawlerStatus == null) $this->crawlerStatus = new Status();
        }
     ...
     *
     * @param Status $crawler_status The status to set
     */
    public function setCrawlerStatus(Status $crawler_status)
    {
        ...
        if ($this->write_status_to_file == true)
        {
            Utils::serializeToFile($this->working_directory."crawlerstatus.tmp", $crawler_status);
        }
    }
    ...
    {
        Benchmark::start("updating_crawler_status");
        ...
        Benchmark::stop("updating_crawler_status");
    }
}
