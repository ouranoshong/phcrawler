...
class ResponseHeader
{
    ...
    public function __construct($header_string, $source_url)
    {
        ...
        $this->http_status_code = Utils::getHTTPStatusCode($header_string);
        $this->content_type = strtolower(Utils::getHeaderValue($header_string, "content-type"));
        $this->content_length = strtolower(Utils::getHeaderValue($header_string, "content-length"));
        $this->cookies = Utils::getCookiesFromHeader($header_string, $source_url);
        $this->transfer_encoding = strtolower(Utils::getHeaderValue($header_string, "transfer-encoding"));
        $this->content_encoding = strtolower(Utils::getHeaderValue($header_string, "content-encoding"));
    }
